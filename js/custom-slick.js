...
$(document).ready(function(){
    ...
    if($(window).width() >= 1024){
        $('.buffalo-slider-for').slick({
                ...
                dots: false,
                arrows: true,
                prevArrow: '<div class="slider-arrows slider-prev"><span class="slider-btn fa-light fa-angle-up flex flex-center"></span></div>',
                nextArrow: '<div class="slider-arrows slider-next"><span class="slider-btn fa-light fa-angle-down flex flex-center"></span></div>',
                focusOnSelect: true,
                vertical: true,
