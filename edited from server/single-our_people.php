                            ...
                            <div class="bio-people-list-main bio-people-expand">
                                <div class="bio-people-expand-content">
                                 ...
                                 <div class="expand-btns flex">
                                    <a href="javascript:void(0);" class="read-btn pos-relative aligncenter btn_show_more">Read More<span class="fa-solid fa-angle-down angle-icon"></span></a>
                                    <a href="javascript:void(0);" class="read-btn pos-relative aligncenter btn_show_less">Read Less<span class="fa-solid fa-angle-up angle-icon"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
