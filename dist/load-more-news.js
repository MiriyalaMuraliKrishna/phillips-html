    ...
    if (jqr5("#ajax-load-more-news").length) {
	 //e = 1,
       ...
       console.log(p);
        ...
        i.append('<div id="load-more-news" class="more blog_more load-more-news"><span class="loader"></span><span class="button btn-transparent"><span>' + jqr5button + "</span></span></div>");
        var u = function() {
