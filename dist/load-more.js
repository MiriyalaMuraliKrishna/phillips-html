    ...
    if (jqr5("#ajax-load-more").length) {
	 //e = 1,
       ...
       console.log(p);
        ...
        i.append('<div id="load-more" class="more blog_more load-more"><span class="loader"></span><span class="button btn-primary"><span>' + jqr5button + "</span></span></div>");
        var u = function() {
            ...
            jqr5.ajax({
                ...
                data: {
                    ...
                    people: s.attr("data-people"),
                    page: s.attr("data-page"),
